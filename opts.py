...
def parse_opt():
    ...
    parser.add_argument('--imgid_key_name', type=str, default='cocoid',
                    help='The name by which the features are saved which is the key of each image. Helps in cases when the differnt datasets are being used.')
